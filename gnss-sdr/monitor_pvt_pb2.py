...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'monitor_pvt_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  DESCRIPTOR._loaded_options = None
  _globals['_MONITORPVT']._serialized_start=32
  _globals['_MONITORPVT']._serialized_end=694
