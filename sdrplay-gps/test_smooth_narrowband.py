...
# Load samples - 30 seconds for extended analysis
print("Loading 30 seconds of data for extended analysis...")
samples = analyzer.load_samples('recordings/gps_recording_20251214_082738.dat',
                                max_samples=int(30 * 2.048e6))
...
plot_narrowband_zoom(f, t, Sxx_db,
                    'recordings/test_smooth_300khz_30sec.png',
                    zoom_bw=300e3,  # ±150 kHz
                    freq_offset=200e3)  # Offset by 200 kHz

print("\n✓ Done! Check: recordings/test_smooth_300khz_30sec.png")
