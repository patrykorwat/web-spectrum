...
# Load samples - 10 seconds for extended analysis
print("Loading 10 seconds of data for extended analysis...")
...
plot_narrowband_zoom(f, t, Sxx_db,
                    'recordings/test_smooth_300khz_10sec.png',
                    zoom_bw=300e3,  # ±150 kHz
                    freq_offset=200e3)  # Offset by 200 kHz

print("\n✓ Done! Check: recordings/test_smooth_300khz_10sec.png")
